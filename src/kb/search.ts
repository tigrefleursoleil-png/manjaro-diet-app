...
const SYNONYMS: Record<string, string[]> = {
  ...
  保険: ["保険適用", "自費", "自由診療", "3割"],
  検査: ["採血", "血液検査", "プリックテスト", "パッチテスト", "アレルゲン", "ige"],
  花粉症: ["スギ", "ヒノキ", "くしゃみ", "鼻水", "鼻づまり", "目のかゆみ"],
  舌下免疫療法: ["減感作", "アレルゲン免疫療法", "シダキュア", "ミティキュア", "ダニ"],
  アトピー: ["湿疹", "皮膚炎", "かゆみ", "保湿", "ステロイド"],
  喘息: ["ぜんそく", "ゼーゼー", "吸入", "咳", "発作"],
  食物アレルギー: ["負荷試験", "除去", "卵", "牛乳", "小麦", "そば", "ナッツ"],
  じんましん: ["蕁麻疹", "発疹", "ブツブツ"],
  予約: ["申し込み", "申込", "受診", "来院", "初診"],
  子ども: ["小児", "こども", "赤ちゃん", "何歳", "小学生"],
  オンライン: ["リモート", "遠隔", "オンライン診療"],
  営業時間: ["診療時間", "何時", "受付時間", "休診"],
};
